...
export default function CoreBrainModules() {
  return (
    <section id="core-brain" className="relative bg-black py-28 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1 — Active */}
          <motion.a
            href="https://mbyte-dashboard-com.vercel.app/"
            target="_blank"
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="text-xl font-bold mb-2 text-white">AI Communication</h3>
              <p className="text-white/50 text-sm leading-relaxed">
                Communicate with your robot via audio using our specialized API services.
              </p>
            </div>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-white/35 text-sm leading-relaxed">
                Comprehensive image project services for visual recognition and processing.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            {/* Text */}
            <div className="flex-1">
              <h3 className="text-xl font-bold mb-2 text-white/60">Machine Learning &amp; Deep Learning</h3>
              <p className="text-white/35 text-sm leading-relaxed">
